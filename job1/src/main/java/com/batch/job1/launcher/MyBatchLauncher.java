package com.batch.job1.launcher;
...
public class MyBatchLauncher {
    ...
    public MyBatchLauncher(@Qualifier("importOrderJob") Job importOrderJob,
    ...
    public void runBatchJob() throws Exception {
        JobParameters jobParameters = new JobParametersBuilder()
                .addString("importOrderJob", String.valueOf(System.currentTimeMillis()))
                .toJobParameters();
